        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <a href="add_ward.jsp" class="btn btn-primary btn-primary pull-right">Add New Ward</a>
                    <br><br>
                    <!-- DataTables Example -->
                    <div class="card mb-3">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="delete_ward.jsp?id=<%=rs.getString(1)%>" onclick = "if (! confirm('Are you sure?')) { return false; }"> <i class="fas fa-trash fa-fw"></i></a></td>
                                        </tr>
                                        <%
                                            }
                                            con.close();
