        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper">
                ...
                <div class="card card-register mx-auto mt-5">
                    <div class="card-header">Assign Ward</div>
                    <div class="card-body">
                        <form action="AssignWard" method="POST">
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-label-group">
                                            <select class="form-control" autofocus="autofocus" name="ward_id">
                                                ...
                                                <%
                                                    ...
                                                    rs.close();
                                                    rs = st.executeQuery("SELECT * FROM nurse_details");
                                                %>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-label-group">
                                            <select class="form-control" autofocus="autofocus" name="nurse_id">
                                                <option>Select ward boy/girl</option>
                                                <%    while (rs.next()) {
                                                %>
                                                <option value="<%=rs.getString(1)%>"><%=rs.getString(2)%></option>
