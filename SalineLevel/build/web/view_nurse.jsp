            ...
            <div id="content-wrapper">
                ...
                <div class="container-fluid">
                    <%//load ward details in table
                        ...
                        ResultSet rs = st.executeQuery("SELECT * FROM nurse_details");
                    %>


                    <a href="add_nurse.jsp" class="btn btn-primary btn-primary pull-right">Add Nurse Details</a>
                    <br><br>
                    <!-- DataTables Example -->
                    <div class="card mb-3">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="change_status.jsp?id=<%=rs.getString(1)%>"><%=rs.getString(10)%></a></td>
                                            <td><a href="delete_nurse.jsp?id=<%=rs.getString(1)%>" onclick = "if (! confirm('Are you sure?')) { return false; }"> <i class="fas fa-trash fa-fw"></i></a></td>
                                        </tr>
                                        <%
                                            }
                                            con.close();
